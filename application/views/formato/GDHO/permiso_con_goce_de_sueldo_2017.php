...
<table style="width: 100%;">
	<tr>
	<td style="text-align: center; border:0px;" colspan="2">PERMISO CON GOCE DE SUELDO 2017</td>
	</tr>
	<tr>
	...
	<tr>
		<td style="border:0px;" colspan="2">
				...
				por medio de la presente hago llegar ante usted una solicitud para que me sea otorgado un <strong>"permiso con goce de sueldo"</strong> 
				con fecha
					<?php 
					 ...
					 ?>
				esto con el motivo de atender una <?php $_GET['motivoPermiso'] ?>
				</p>
